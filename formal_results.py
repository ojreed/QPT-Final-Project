...
TC.test_fast_algo_S("Fast Algo Lintner - Daily",Asset_list,Initial_allocation,0)

TC.test_fast_algo_S("Fast Algo Lintner - Monthly",Asset_list,Initial_allocation,1)

TC.test_fast_algo_S("Fast Algo Lintner - Yearly",Asset_list,Initial_allocation,2)
